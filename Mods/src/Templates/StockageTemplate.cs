...
namespace Village.Eco.Mods.Templates
{
    ...
    public partial class StockageTemplateObject : WorldObject, IRepresentsItem
    {
    ...
    [Weight(500)]
    public partial class StockageTemplateItem : WorldObjectItem<StockageTemplateObject>
    {
    ...
    #region Recipe
    [Ecopedia("Crafted Objects", "Storage", subPageName: "Stockage Template Item")]
    public partial class StockageTemplateRecipe : RecipeFamily
    {
        public StockageTemplateRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "StockageTemplate",  //noloc
                ...
                {
                    new CraftingElement<StockageTemplateItem>()
                });
            ...
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Stockage Template"), recipeType: typeof(StockageTemplateRecipe));
            this.ModsPostInitialize();
