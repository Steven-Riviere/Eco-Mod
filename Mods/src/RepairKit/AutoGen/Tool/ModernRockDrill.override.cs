...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ModernRockDrill".</para>
    ...
    public partial class ModernRockDrillRecipe : RecipeFamily
    {
        public ModernRockDrillRecipe()
        {
            ...
            recipe.Init(
                name: "ModernRockDrill",  //noloc
                displayName: Localizer.DoStr("Modern Rock Drill"),
            ...
            this.Initialize(displayText: Localizer.DoStr("Modern Rock Drill"), recipeType: typeof(ModernRockDrillRecipe));
