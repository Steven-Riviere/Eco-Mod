...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "IronMachete".</para>
    ...
    [Ecopedia("Items", "Tools", subPageName: "Iron Machete Item")]
    public partial class IronMacheteRecipe : RecipeFamily
    {
        public IronMacheteRecipe()
        {
            ...
            recipe.Init(
                name: "IronMachete",  //noloc
                displayName: Localizer.DoStr("Iron Machete"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(IronMacheteRecipe), start: 0.5f, skillType: typeof(BlacksmithSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Iron Machete"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Iron Machete"), recipeType: typeof(IronMacheteRecipe));
