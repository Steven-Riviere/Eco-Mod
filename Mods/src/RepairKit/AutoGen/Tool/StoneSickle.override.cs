...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "StoneSickle".</para>
    ...
    /// </remarks>
    [Ecopedia("Items", "Tools", subPageName: "Stone Sickle Item")]
    public partial class StoneSickleRecipe : RecipeFamily
    {
        public StoneSickleRecipe()
        {
            ...
            recipe.Init(
                name: "StoneSickle",  //noloc
                displayName: Localizer.DoStr("Stone Sickle"),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Stone Sickle"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Stone Sickle"), recipeType: typeof(StoneSickleRecipe));
    ...
    [LocDescription("A stone sickle used to harvest crops or cut grass.")]
    [Tier(1)]
    [Weight(1000)]
    [Category("Tool")]
    [Tag("Tool")]
