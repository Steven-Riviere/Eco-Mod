...
// Le village - Intégration Repair Kit routier en pierre
...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "StoneRoadTool".</para>
    ...
    [Ecopedia("Items", "Tools", subPageName: "Stone Road Tool Item")]
    public partial class StoneRoadToolRecipe : RecipeFamily
    {
        public StoneRoadToolRecipe()
        {
            ...
            recipe.Init(
                name: "StoneRoadTool",  //noloc
                displayName: Localizer.DoStr("Stone Road Tool"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(StoneRoadToolRecipe), start: 0.5f, skillType: typeof(BasicEngineeringSkill), typeof(BasicEngineeringFocusedSpeedTalent), typeof(BasicEngineeringParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Stone Road Tool"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Stone Road Tool"), recipeType: typeof(StoneRoadToolRecipe));
    ...
    public partial class StoneRoadToolItem : RoadToolItem
    {
        ...
        public override Item RepairItem                 => Item.Get<StoneRoadRepairKitItem>();
