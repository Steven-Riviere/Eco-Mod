...
// Le village - Intégration Repair Kit en fer
...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "IronHoe".</para>
    ...
    [Ecopedia("Items", "Tools", subPageName: "Iron Hoe Item")]
    public partial class IronHoeRecipe : RecipeFamily
    {
        public IronHoeRecipe()
        {
            ...
            recipe.Init(
                name: "IronHoe",  //noloc
                displayName: Localizer.DoStr("Iron Hoe"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(IronHoeRecipe), start: 0.5f, skillType: typeof(BlacksmithSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Iron Hoe"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Iron Hoe"), recipeType: typeof(IronHoeRecipe));
    ...
    {
                                                                                                                                                                                                                                           // Static values
        private static IDynamicValue caloriesBurn           = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(IronHoeItem), typeof(ToolEfficiencyTalent)), CreateCalorieValue(20, typeof(FarmingSkill), typeof(IronHoeItem)));
