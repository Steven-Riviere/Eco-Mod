...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SteelAxe".</para>
    ...
    [Ecopedia("Items", "Tools", subPageName: "Steel Axe Item")]
    public partial class SteelAxeRecipe : RecipeFamily
    {
        public SteelAxeRecipe()
        {
            ...
            recipe.Init(
                name: "SteelAxe",  //noloc
                displayName: Localizer.DoStr("Steel Axe"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SteelAxeRecipe), start: 0.5f, skillType: typeof(BlacksmithSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Steel Axe"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Steel Axe"), recipeType: typeof(SteelAxeRecipe));
    ...
    {
                                                                                                                                                                                                                                           // Static values
        private static IDynamicValue caloriesBurn           = new MultiDynamicValue(MultiDynamicOps.Multiply, new TalentModifiedValue(typeof(SteelAxeItem), typeof(LoggingToolEfficiencyTalent)), CreateCalorieValue(20, typeof(LoggingSkill), typeof(SteelAxeItem)));
        private static IDynamicValue damage                 = new MultiDynamicValue(MultiDynamicOps.Sum, new TalentModifiedValue(typeof(SteelAxeItem), typeof(LoggingToolStrengthTalent), 0), CreateDamageValue(2, typeof(LoggingSkill), typeof(SteelAxeItem)));
        ...
        private static IDynamicValue perkDamage             = new MultiDynamicValue(MultiDynamicOps.Sum, new ConstantValue(0), new TalentModifiedValue(typeof(SteelAxeItem), typeof(LoggingToolStrengthTalent), 0));
