...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "IronSickle".</para>
    ...
    public partial class IronSickleRecipe : RecipeFamily
    {
        public IronSickleRecipe()
        {
            ...
            recipe.Init(
                name: "IronSickle",  //noloc
                displayName: Localizer.DoStr("Iron Sickle"),
            ...
            this.Initialize(displayText: Localizer.DoStr("Iron Sickle"), recipeType: typeof(IronSickleRecipe));
