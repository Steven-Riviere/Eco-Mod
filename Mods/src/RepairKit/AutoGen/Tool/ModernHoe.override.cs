...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ModernHoe".</para>
    ...
    [Ecopedia("Items", "Tools", subPageName: "Modern Hoe Item")]
    public partial class ModernHoeRecipe : RecipeFamily
    {
        public ModernHoeRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "ModernHoe",  //noloc
                displayName: Localizer.DoStr("Modern Hoe"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ModernHoeRecipe), start: 0.5f, skillType: typeof(BlacksmithSkill), typeof(BlacksmithFocusedSpeedTalent), typeof(BlacksmithParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Modern Hoe"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Modern Hoe"), recipeType: typeof(ModernHoeRecipe));
...

    {
        ...
        static readonly AreaOfEffectMode areaOfEffectMode = AOEFactory.Make("MultiBlock", true, "0,0,1;0,0,2", 0, 0, 0);
