...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "StonePickaxe".</para>
    ...
    /// </remarks>
    [Ecopedia("Items", "Tools", subPageName: "Stone Pickaxe Item")]
    public partial class StonePickaxeRecipe : RecipeFamily
    {
        public StonePickaxeRecipe()
        {
            ...
            recipe.Init(
                name: "StonePickaxe",  //noloc
                displayName: Localizer.DoStr("Stone Pickaxe"),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Stone Pickaxe"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Stone Pickaxe"), recipeType: typeof(StonePickaxeRecipe));
    ...
    [LocDescription("A crude pickaxe used to break down stone and ore into usable rubble.")]
    [Tier(1)]
    [Weight(1000)]
    [Category("Tool")]
    [Tag("Tool")]
    ...
    public partial class StonePickaxeItem : PickaxeItem
    {
        ...
        private static IDynamicValue damage                 = new ConstantValue(1);
        private static IDynamicValue exp                    = new ConstantValue(0.1f);
        private static IDynamicValue tier                   = new ConstantValue(1);
        private static IDynamicValue perkDamage             = new MultiDynamicValue(MultiDynamicOps.Sum, new ConstantValue(0), new TalentModifiedValue(typeof(StonePickaxeItem), typeof(MiningToolStrengthTalent), 0));
