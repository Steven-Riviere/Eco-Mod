...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SteamTractorPlow".</para>
    ...
    [Ecopedia("Items", "Tools", subPageName: "Steam Tractor Plow Item")]
    public partial class SteamTractorPlowRecipe : RecipeFamily
    {
        public SteamTractorPlowRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SteamTractorPlow",  //noloc
                displayName: Localizer.DoStr("Steam Tractor Plow"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SteamTractorPlowRecipe), start: 2, skillType: typeof(MechanicsSkill), typeof(MechanicsFocusedSpeedTalent), typeof(MechanicsParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Steam Tractor Plow"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Steam Tractor Plow"), recipeType: typeof(SteamTractorPlowRecipe));
    ...
    [LocDisplayName("Steam Tractor Plow")] // Defines the localized name of the item.
    [Weight(10000)] // Defines how heavy SteamTractorPlow is.
    ...
    [Tag("Tool")]
    [LocDescription("An attachment for the steam tractor that allows for quick plowing.")] //The tooltip description for the item.
