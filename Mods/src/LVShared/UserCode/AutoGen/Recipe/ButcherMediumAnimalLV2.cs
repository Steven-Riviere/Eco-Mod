...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ButcherMediumAnimalLV2Recipe : RecipeFamily
    {
        public ButcherMediumAnimalLV2Recipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement("MediumLeatherCarcass", 1, typeof(ButcherySkill), typeof(ButcheryLavishResourcesTalent)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ButcherMediumAnimalLV2Recipe), start: 1.5f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Butcher Medium Animal"), recipeType: typeof(ButcherMediumAnimalLV2Recipe));
