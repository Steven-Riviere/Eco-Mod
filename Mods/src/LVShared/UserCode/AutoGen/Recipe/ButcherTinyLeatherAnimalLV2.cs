...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ButcherTinyLeatherAnimalLV2Recipe : RecipeFamily
    {
        public ButcherTinyLeatherAnimalLV2Recipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement("TinyLeatherCarcass", 1, typeof(ButcherySkill), typeof(ButcheryLavishResourcesTalent)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ButcherTinyLeatherAnimalLV2Recipe), start: 0.5f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Butcher Tiny Leather Animal"), recipeType: typeof(ButcherTinyLeatherAnimalLV2Recipe));
