...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ButcherHareRecipe : RecipeFamily
    {
        public ButcherHareRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ButcherHareRecipe), start: 1, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Butcher Hare"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Butcher Hare"), recipeType: typeof(ButcherHareRecipe));
