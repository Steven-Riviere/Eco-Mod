...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CutBison".</para>
        ...
        public CutBisonRecipe()
        {
            ...
            recipe.Init(
                ...
                items: new List<CraftingElement>
                {
                    ...
                    new CraftingElement<LeatherHideItem>(4),
                    new CraftingElement<ShornWoolItem>(6),
                });
            ...
            this.Initialize(displayText: Localizer.DoStr("Butcher Bison"), recipeType: typeof(CutBisonRecipe));
