...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ButcherBisonRecipe : RecipeFamily
    {
        public ButcherBisonRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ButcherBisonRecipe), start: 4, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Butcher Bison"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Butcher Bison"), recipeType: typeof(ButcherBisonRecipe));
