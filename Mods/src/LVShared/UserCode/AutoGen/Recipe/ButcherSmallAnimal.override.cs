...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ButcherSmallAnimalRecipe : RecipeFamily
    {
        public ButcherSmallAnimalRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ButcherSmallAnimalRecipe), start: 2, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Butcher Small Animal"), recipeType: typeof(ButcherSmallAnimalRecipe));
