...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ButcherHareLV2Recipe : RecipeFamily
    {
        public ButcherHareLV2Recipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ButcherHareLV2Recipe), start: 0.5f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Butcher Hare"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Butcher Hare"), recipeType: typeof(ButcherHareLV2Recipe));
