...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ButcherSmallAnimalLV3Recipe : RecipeFamily
    {
        public ButcherSmallAnimalLV3Recipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement("SmallCarcass", 2, typeof(ButcherySkill), typeof(ButcheryLavishResourcesTalent)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ButcherSmallAnimalLV3Recipe), start: 1, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
            ...
            this.Initialize(displayText: Localizer.DoStr("Butcher Small Animal"), recipeType: typeof(ButcherSmallAnimalLV3Recipe));
