// Le village
// Ralentir le Temps et enlever les Scraps
...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RawRoastRecipe : RecipeFamily
    {
        public RawRoastRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawRoastRecipe), start: 1.6f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Raw Roast"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Raw Roast"), recipeType: typeof(RawRoastRecipe));
