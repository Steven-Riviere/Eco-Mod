...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "RawSausageLV3" item. 
    ...
    [Weight(300)] // Defines how heavy the RawSausageLV3 is.
    ...
    public partial class RawSausageLV3Item : FoodItem
    {
    ...
    /// <summary>
    /// <para>Server side recipe definition for "RawSausageLV3".</para>
    ...
    public partial class RawSausageLV3Recipe : RecipeFamily
    {
        public RawSausageLV3Recipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "RawSausageLV3",  //noloc
                ...
                {
                    new IngredientElement(typeof(ScrapMeatItem), 2, typeof(ButcherySkill), typeof(ButcheryLavishResourcesTalent)),
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawSausageLV3Recipe), start: 0.8f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Raw Sausage LV3"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Raw Sausage"), recipeType: typeof(RawSausageLV3Recipe));
