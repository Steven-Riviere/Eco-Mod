...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "RawSausage" item. 
    ...
    [Weight(300)] // Defines how heavy the RawSausage is.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "RawSausage".</para>
    ...
    public partial class RawSausageRecipe : RecipeFamily
    {
        public RawSausageRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawSausageRecipe), start: 1.6f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Raw Sausage"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Raw Sausage"), recipeType: typeof(RawSausageRecipe));
