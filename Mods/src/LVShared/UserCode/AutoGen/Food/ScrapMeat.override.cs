...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "ScrapMeat" item. 
    ...
    [LocDisplayName("Scrap Meat")] // Defines the localized name of the item.
    [Weight(75)] // Defines how heavy the ScrapMeat is.
    [Ecopedia("Food", "Raw Meat", createAsSubPage: true)]
    [LocDescription("Chunks of extra meat.")] //The tooltip description for the food item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ScrapMeat".</para>
    ...
    [Ecopedia("Food", "Raw Meat", subPageName: "Scrap Meat Item")]
    public partial class ScrapMeatRecipe : RecipeFamily
    {
        public ScrapMeatRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ScrapMeatRecipe), start: 1.0f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
