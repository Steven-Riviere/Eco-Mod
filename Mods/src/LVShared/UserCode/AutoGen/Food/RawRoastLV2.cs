// LE village
// Remettre le temps et enlever les Scraps
...
namespace Eco.Mods.TechTree
{
    ...
    public partial class RawRoastLV2Item : FoodItem
    {
    ...
    public partial class RawRoastLV2Recipe : RecipeFamily
    {
        public RawRoastLV2Recipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawRoastLV2Recipe), start: 0.8f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Raw Roast"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Raw Roast"), recipeType: typeof(RawRoastLV2Recipe));
