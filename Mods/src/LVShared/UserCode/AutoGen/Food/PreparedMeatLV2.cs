...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "PreparedMeatLV2" item. 
    ...
    [Weight(400)] // Defines how heavy the PreparedMeatLV2 is.
    ...
    public partial class PreparedMeatLV2Item : FoodItem
    {
    ...
    /// <summary>
    /// <para>Server side recipe definition for "PreparedMeatLV2".</para>
    ...
    public partial class PreparedMeatLV2Recipe : RecipeFamily
    {
        public PreparedMeatLV2Recipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(RawMeatItem), 5, typeof(ButcherySkill), typeof(ButcheryLavishResourcesTalent)),
                },
                ...
                {
                    new CraftingElement<PreparedMeatItem>(2),
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Prepared Meat LV2"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Prepared Meat"), recipeType: typeof(PreparedMeatLV2Recipe));
