...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "FoxCarcass" item.</para>
    ...
    [LocDisplayName("Fox Carcass")] // Defines the localized name of the item.
    [Weight(2000)] // Defines how heavy FoxCarcass is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("SmallCarcass")]
    [Tag("Carcasse")]
    [LocDescription("A dead fox.")] //The tooltip description for the item.
    public partial class FoxCarcassItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Fox Carcass");
