...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "FurPelt" item.</para>
    ...
    [LocDisplayName("Fur Pelt")] // Defines the localized name of the item.
    [Weight(250)] // Defines how heavy FurPelt is.
    //[Tag("Currency")][Currency] // Defines if this item can be used to back a currency  //Le Village
    [Ecopedia("Items", "Products", createAsSubPage: true)]
    [Tag("Animal Skin")]
    [LocDescription("A soft, furry pelt.")] //The tooltip description for the item.
    public partial class FurPeltItem : Item    {
