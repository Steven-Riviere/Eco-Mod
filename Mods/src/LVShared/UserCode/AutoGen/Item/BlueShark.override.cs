...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "BlueShark" item.</para>
    ...
    [LocDisplayName("Blue Shark")] // Defines the localized name of the item.
    [Weight(2000)] // Defines how heavy BlueShark is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("Fish")]
    [Tag("LargeFish")]
    [Tag("Carcasse")]
    [LocDescription("A blue shark.")] //The tooltip description for the item.
    public partial class BlueSharkItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Blue Shark Carcass");
