...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "AlligatorCarcass" item.</para>
    ...
    [LocDisplayName("Alligator Carcass")] // Defines the localized name of the item.
    [Weight(2000)] // Defines how heavy AlligatorCarcass is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("MediumCarcass")]
    [Tag("MediumLeatherCarcass")]
    [Tag("Carcasse")]
    [LocDescription("A dead alligator.")] //The tooltip description for the item.
    public partial class AlligatorCarcassItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Alligator Carcass");
