...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "Cod" item.</para>
    ...
    [LocDisplayName("Cod")] // Defines the localized name of the item.
    [Weight(1000)] // Defines how heavy Cod is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("Fish")]
    [Tag("MediumFish")]
    [Tag("Carcasse")]
    [LocDescription("A cod.")] //The tooltip description for the item.
    public partial class CodItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Cod Carcass");
