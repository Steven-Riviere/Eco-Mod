...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "CoyoteCarcass" item.</para>
    ...
    [LocDisplayName("Coyote Carcass")] // Defines the localized name of the item.
    [Weight(2000)] // Defines how heavy CoyoteCarcass is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("SmallCarcass")]
    [Tag("Carcasse")]
    [LocDescription("A dead coyote.")] //The tooltip description for the item.
    public partial class CoyoteCarcassItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Coyote Carcass");
