...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "DeerCarcass" item.</para>
    ...
    [LocDisplayName("Deer Carcass")] // Defines the localized name of the item.
    [Weight(3000)] // Defines how heavy DeerCarcass is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("MediumCarcass")]
    [Tag("MediumLeatherCarcass")]
    [Tag("Carcasse")]
    [LocDescription("A dead deer.")] //The tooltip description for the item.
    public partial class DeerCarcassItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Deer Carcass");
