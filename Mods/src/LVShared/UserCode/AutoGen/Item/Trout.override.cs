...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "Trout" item.</para>
    ...
    [LocDisplayName("Trout")] // Defines the localized name of the item.
    [Weight(800)] // Defines how heavy Trout is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("Fish")]
    [Tag("MediumFish")]
    [Tag("Carcasse")]
    [LocDescription("A trout.")] //The tooltip description for the item.
    public partial class TroutItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Trout Carcass");
