...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "HareCarcass" item.</para>
    ...
    [LocDisplayName("Hare Carcass")] // Defines the localized name of the item.
    [Weight(1000)] // Defines how heavy HareCarcass is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("TinyCarcass")]
    [Tag("Carcasse")]
    [LocDescription("A dead hare.")] //The tooltip description for the item.
    public partial class HareCarcassItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Hare Carcass");
