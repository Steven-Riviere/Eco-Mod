...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "Tuna" item.</para>
    ...
    [LocDisplayName("Tuna")] // Defines the localized name of the item.
    [Weight(1250)] // Defines how heavy Tuna is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("Fish")]
    [Tag("LargeFish")]
    [Tag("Carcasse")]
    [LocDescription("A tuna.")] //The tooltip description for the item.
    public partial class TunaItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Tauna Carcass");
