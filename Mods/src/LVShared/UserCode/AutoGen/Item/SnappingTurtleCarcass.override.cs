...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "SnappingTurtleCarcass" item.</para>
    ...
    [LocDisplayName("Snapping Turtle Carcass")] // Defines the localized name of the item.
    [Weight(2000)] // Defines how heavy SnappingTurtleCarcass is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("TinyLeatherCarcass")]
    [Tag("TinyCarcass")]
    [Tag("Carcasse")]
    [LocDescription("A dead snapping turtle.")] //The tooltip description for the item.
    public partial class SnappingTurtleCarcassItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Snapping Turtle Carcass");
