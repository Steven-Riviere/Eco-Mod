...
namespace Village.Eco.Mods.FacteurMod
{
    ...
    [Tag("Usable")]
    [Ecopedia("Crafted Objects", "Storage", subPageName: "Boite aux lettres Tier 3 type 1 Item")]
    public partial class BoiteAuxLettresTier3Type1Object : WorldObject
    {
        public override LocString DisplayName => Localizer.DoStr("Boite aux lettres Tier 3 type 1");
    ...
    [Serialized]
    [LocDisplayName("Boite aux lettres Tier 3 type 1")]
    ...
    public partial class BoiteAuxLettresTier3Type1Item : WorldObjectItem<BoiteAuxLettresTier3Type1Object>
    {
    ...
    public partial class BoiteAuxLettresTier3Type1Recipe : RecipeFamily
    {
        public BoiteAuxLettresTier3Type1Recipe()
        {
            ...
            recipe.Init(
                ...
                displayName: Localizer.DoStr("Boite aux Lettres Tier 3 type 1"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BoiteAuxLettresTier3Type1Recipe), start: 8, skillType: typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Boite aux Lettres Tier 3"), recipeType: typeof(BoiteAuxLettresTier3Type1Recipe));
            this.ModsPostInitialize();
