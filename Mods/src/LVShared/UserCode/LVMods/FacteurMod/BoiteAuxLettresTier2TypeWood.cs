...
namespace Village.Eco.Mods.FacteurMod
{
    ...
    {
        public override LocString DisplayName => Localizer.DoStr("Boite aux lettres Tier 2 type bois Item");
    ...
    [Serialized]
    [LocDisplayName("Boite aux lettres Tier 2")]
    ...
    public partial class BoiteAuxLettresTier2TypeWoodRecipe : RecipeFamily
    {
        public BoiteAuxLettresTier2TypeWoodRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement("Wood", 10, typeof(CarpentrySkill), typeof(CarpentryLavishResourcesTalent)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BoiteAuxLettresTier2TypeWoodRecipe), start: 15, skillType: typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));
