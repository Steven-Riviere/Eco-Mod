// Le Village Duplication de livre T1
...
namespace Eco.Mods.TechTree
{
    ...
    public partial class BookTier1LV2Recipe : RecipeFamily
    {
        public BookTier1LV2Recipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(BookTier1Item), 1),  //	Duplication d'un Boook de tier 1 en 10 Book de tier 1				
                },
                ...
                {
                    new CraftingElement<BookTier1Item>(10)
                });
            ...
            this.LaborInCalories = CreateLaborInCaloriesValue(1000);   //10 calories !!
