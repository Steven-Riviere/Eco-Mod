// Le Village Duplication de livre T2
...
namespace Eco.Mods.TechTree
{
    ...
    public partial class BookTier2LV2Recipe : RecipeFamily
    {
        public BookTier2LV2Recipe ()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(BookTier2Item), 1),  //	Duplication d'un Boook de tier 2 en 10 Book de tier 1				
                },
                ...
                {
                    new CraftingElement<BookTier2Item>(10)
                });
