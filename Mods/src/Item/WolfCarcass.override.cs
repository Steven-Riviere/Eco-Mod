...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "WolfCarcass" item.</para>
    ...
    [LocDisplayName("Wolf Carcass")] // Defines the localized name of the item.
    [Weight(2000)] // Defines how heavy WolfCarcass is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("SmallCarcass")]
    [Tag("Carcasse")]
    [LocDescription("A dead wolf.")] //The tooltip description for the item.
    public partial class WolfCarcassItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Wolf Carcass");
