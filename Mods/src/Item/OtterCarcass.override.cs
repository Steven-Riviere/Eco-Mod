...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "OtterCarcass" item.</para>
    ...
    [LocDisplayName("Otter Carcass")] // Defines the localized name of the item.
    [Weight(1000)] // Defines how heavy OtterCarcass is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("TinyFurCarcass")]
    [Tag("TinyCarcass")]
    [Tag("Carcasse")]
    [LocDescription("A dead otter.")] //The tooltip description for the item.
    public partial class OtterCarcassItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Otter Carcass");
