...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "PacificSardine" item.</para>
    ...
    [LocDisplayName("Pacific Sardine")] // Defines the localized name of the item.
    [Weight(150)] // Defines how heavy PacificSardine is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("Fish")]
    [Tag("Carcasse")]
    [LocDescription("A pacific sardine.")] //The tooltip description for the item.
    public partial class PacificSardineItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Pacific Sardine Carcass");
