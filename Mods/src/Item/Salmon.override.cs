...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "Salmon" item.</para>
    ...
    [LocDisplayName("Salmon")] // Defines the localized name of the item.
    [Weight(1000)] // Defines how heavy Salmon is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("Fish")]
    [Tag("MediumFish")]
    [Tag("Carcasse")]
    [LocDescription("A salmon.")] //The tooltip description for the item.
    public partial class SalmonItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Salmon Carcass");
