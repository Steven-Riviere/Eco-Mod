...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "JaguarCarcass" item.</para>
    ...
    [LocDisplayName("Jaguar Carcass")] // Defines the localized name of the item.
    [Weight(2000)] // Defines how heavy JaguarCarcass is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("MediumCarcass")]
    [Tag("MediumLeatherCarcass")]
    [Tag("Carcasse")]
    [LocDescription("A dead Jaguar.")] //The tooltip description for the item.
    public partial class JaguarCarcassItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Jaguar Carcass");
