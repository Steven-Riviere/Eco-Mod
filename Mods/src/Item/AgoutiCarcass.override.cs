...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "AgoutiCarcass" item.</para>
    ...
    [LocDisplayName("Agouti Carcass")] // Defines the localized name of the item.
    [Weight(2000)] // Defines how heavy AgoutiCarcass is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("TinyFurCarcass")]
    [Tag("TinyCarcass")]
    [Tag("Carcasse")]
    [LocDescription("A dead agouti.")] //The tooltip description for the item.
    public partial class AgoutiCarcassItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Agouti Carcass");
