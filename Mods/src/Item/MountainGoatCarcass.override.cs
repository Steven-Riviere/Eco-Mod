...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "MountainGoatCarcass" item.</para>
    ...
    [LocDisplayName("Mountain Goat Carcass")] // Defines the localized name of the item.
    [Weight(3000)] // Defines how heavy MountainGoatCarcass is.
    [Ecopedia("Natural Resources", "Animal", createAsSubPage: true)]
    [Tag("MediumCarcass")]
    [Tag("MediumWoolyCarcass")]
    [Tag("Carcasse")]
    [LocDescription("A dead mountain goat.")] //The tooltip description for the item.
    public partial class MountainGoatCarcassItem : FoodItem
    {
        public override LocString DisplayNamePlural => Localizer.DoStr("Mountain Goat Carcass");
